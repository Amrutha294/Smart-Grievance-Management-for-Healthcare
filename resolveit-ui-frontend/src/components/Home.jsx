    ...
    <div className="home-page">
      ...
      <main className="home-hero">
        ...
        <p className="hero-subtitle">
          ...
          patient satisfaction with our comprehensive hospital management system.
        </p>
        ...
        <div className="feature-grid">
          <div className="feature-card">
            <span className="feature-icon"><img src="/src/assets/secure.png" className="app-logo" alt="ResolveIT Logo" /></span>
            <h3>Secure & Private</h3>
            <p>All grievances are stored safely and accessed only by authorized staff.</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon"><img src="/src/assets/time.png" className="app-logo" alt="ResolveIT Logo" /></span>
            <h3>Real-time Tracking</h3>
            <p>Track the status of grievances from submission to resolution.</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon"><img src="/src/assets/correct.png" className="app-logo" alt="ResolveIT Logo" /></span>
